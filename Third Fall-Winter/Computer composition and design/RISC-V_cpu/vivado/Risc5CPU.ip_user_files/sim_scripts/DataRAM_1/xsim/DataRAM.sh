...
#
# Generated by Vivado on Sat Dec 21 01:31:32 +0800 2019
...
# Script info
echo -e "DataRAM.sh - Script generated by export_simulation (Vivado v2017.4 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L dist_mem_gen_v8_0_12 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DataRAM xil_defaultlib.DataRAM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DataRAM -key {Behavioral:sim_1:Functional:DataRAM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DataRAM.wdb xsim.dir)
