...
int main(int argc, char *argv[])
{
  ...
  /* STUDENT CODE START HERE. */		
			...
			num = (atoi(arg2) << ADDI_IMM_SHIFT) | (atoi(arg1) << RS1_SHIFT) | ADDI_FUNC3<<FUNCT3_SHIFT | (atoi(arg0) << RD_SHIFT) | ADDI_OP;
		}
			...
			if (flag  < 0)
			{
                num = (atoi(arg2) << LW_IMM_SHIFT) | (atoi(arg1) << RS1_SHIFT) | LW_FUNC3<<FUNCT3_SHIFT | (atoi(arg0) << RD_SHIFT) | LW_OP;
			}
			else
			{
				num = (get_label_address(arg2) << LW_IMM_SHIFT) | (atoi(arg1) << RS1_SHIFT) | LW_FUNC3<<FUNCT3_SHIFT | (atoi(arg0) << RD_SHIFT) | LW_OP;
			}	
		}
			...
			if (flag  < 0)
			{
                num = ( (atoi(arg2) & 0xFE0) << 20) | (atoi(arg0) << RS2_SHIFT) | (atoi(arg1) << RS1_SHIFT) | SW_FUNC3<<FUNCT3_SHIFT | ( (atoi(arg2) & 0x1F) << RD_SHIFT) | SW_OP;  
			}
			else
			{
				num = (((get_label_address(arg2)) & 0xFE0) << 20) | (atoi(arg0) << RS2_SHIFT) | (atoi(arg1) << RS1_SHIFT) | SW_FUNC3<<FUNCT3_SHIFT | ((get_label_address(arg2) & 0x1F) << RD_SHIFT) | SW_OP;
			}		
			...
			if (flag  < 0)
			{
				num = ( (atoi(arg2) & 0x1000)<< 19) | ( (atoi(arg2) & 0x7E0) << 20) | (atoi(arg1) << RS2_SHIFT) | (atoi(arg0) << RS1_SHIFT) | BEQ_FUNC3<<FUNCT3_SHIFT | ( (atoi(arg2) & 0x1E) << RD_SHIFT) | ( (atoi(arg2) & 0x800) >> 4)| BEQ_OP; 
			}
			else
			{
				num = ( ((get_label_address(arg2)-address) & 0x1000)<< 19) | ( ((get_label_address(arg2)-address) & 0x7E0) << 20) | (atoi(arg1) << RS2_SHIFT) | (atoi(arg0) << RS1_SHIFT) | BEQ_FUNC3<<FUNCT3_SHIFT | ( ((get_label_address(arg2)-address) & 0x1E) << RD_SHIFT) | ( ((get_label_address(arg2)-address) & 0x800) >> 4)| BEQ_OP;
			}
		}
  /* STUDENT CODE END. */
